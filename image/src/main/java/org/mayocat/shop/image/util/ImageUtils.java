package org.mayocat.shop.image.util;
...
public class ImageUtils
{
     ...
     * @return the image ratio, under the form <code</>x:y</code> where x represents the horizontal dimension
     * and y the vertical dimension of the ratio
     */
