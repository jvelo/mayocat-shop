(function () {
    ...
    .factory('timeService', function () {
        ...
        // List of time zones and standard offset generated with joda DateTimeZone
        var tzChoices = {
            Africa: {
            ...
            America: {
                ...
                "America/Nipigon":        { stdOffset: "-05:00", city: "Nipigon"  },
                "America/Panama":         { stdOffset: "-05:00", city: "Panama"  },
                "America/Pangnirtung":    { stdOffset: "-05:00", city: "Pangnirtung"  },
                "America/Port-au-Prince": { stdOffset: "-05:00", city: "Port-au-Prince"  },
                "America/Resolute":       { stdOffset: "-05:00", city: "Resolute"  },
                "America/Thunder_Bay":    { stdOffset: "-05:00", city: "Thunder Bay"  },
                "America/Toronto":        { stdOffset: "-05:00", city: "Toronto"  },
                "America/Caracas":        { stdOffset: "-04:30", city: "Caracas"  },
                "America/Anguilla":       { stdOffset: "-04:00", city: "Anguilla"  },
                "America/Antigua":        { stdOffset: "-04:00", city: "Antigua"  },
            ...
            Asia: {
                ...
                "Asia/Chongqing":     { stdOffset: "+08:00", city: "Chongqing" },
                "Asia/Harbin":        { stdOffset: "+08:00", city: "Harbin" },
                "Asia/Hong_Kong":     { stdOffset: "+08:00", city: "Hong Kong" },
                "Asia/Kashgar":       { stdOffset: "+08:00", city: "Kashgar" },
